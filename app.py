...
from randomForestClassifier import randomForestClassifier  # pyright: ignore[reportMissingImports]
...
def predict_clinical(M, O, J, C, H, PC, genotype):
    label=randomForestClassifier.predict(M, O, J, C, H, PC, genotype)
    confidence = randomForestClassifier.predict_proba(M, O, J, C, H, PC, genotype)
    final_probs = randomForestClassifier.predict_proba(M, O, J, C, H, PC, genotype)
    global_cdr = randomForestClassifier.predict_proba(M, O, J, C, H, PC, genotype)
    cdr_sb = randomForestClassifier.predict_proba(M, O, J, C, H, PC, genotype)
    reasoning = randomForestClassifier.predict_proba(M, O, J, C, H, PC, genotype)
